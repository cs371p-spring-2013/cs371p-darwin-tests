	...
	try {
		...
		*/
		...
		if (print_results) {
			...
			for (int x = 0; x < b._height * b._width; x++) {
				switch (b._board[x]._type) {
				case FOOD :
					num_food++;
					break;
				case HOPPER :
			...
			cout << "hopper = " << num_hopper << endl;
			cout << "rover = " << num_rover << endl;
			cout << "trap = " << num_trap << endl;
			cout << "best = " << num_best << endl << endl;
		}
