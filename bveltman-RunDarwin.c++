...
int main () {
    ...
    */
    ...
    try {
       ...
       DarwinGame<72, 72> g;
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        ...
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(FOOD, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        ...
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(HOPPER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        ...
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(ROVER, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
    ...
    try {
        ...
        */
        ...
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(TRAP, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(BEST, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(BEST, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(BEST, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(BEST, std::rand()%4, std::rand()%72, std::rand()%72);
        g.addCreature(BEST, std::rand()%4, std::rand()%72, std::rand()%72);
